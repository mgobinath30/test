<template>
  <span>
    <v-btn class="applozic-launcher" @click.prevent="show = true" color="green" v-if="privileges.chat.private_chat" fixed dark bottom right fab>
        <v-icon>mdi-forum</v-icon>
    </v-btn>
    <div class="fullchat-view" :class="{ 'hidden': !show }" @click.self="clickOutside">
        <div class="mck-container fade" :class="{ 'in': show }">
            <div class="left mck-message-inner-left">
                <div class="panel-content">
                    <div class="mck-box-top mck-row mck-wt-user-icon">
                        ...
                        <div class="blk-lg-2 move-right mck-menu-item mck-text-right">
                            <div class="mck-dropdown-toggle" data-toggle="mckdropdown" aria-expanded="true">
                                <img src="/static/images/icon-menu.png" class="mck-menu-icon" alt="Menu">
                            </div>
                            <ul id="mck-start-new-menu-box" class="mck-dropdown-menu mck-tab-menu-box menu-right" role="menu">
                                <li>
                                    <a href="#" id="mck-msg-new" class="mck-contact-search menu-item" title="New Chat">New Chat</a>
                                </li>
                                <li>
                                    <a href="#" class="mck-contact-search menu-item" title="Contacts">Contacts</a>
                                </li>
                                <li v-if="privileges.chat.group_chat">
                                    <a href="#" class="mck-group-search menu-item" title="Groups">Groups</a>
                                </li>
                                <li v-if="privileges.chat.group_chat">
                                    <a href="#" id="mck-new-group" class="menu-item" title="Create Group">Create Group</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="top">
                        ...
                        </span> <input type="text" id="mck-search" data-provide="typeahead" placeholder="Search..." autofocus />
                    </div>
                    <div class="mck-panel-body">
                        <div id="mck-contact-cell" class="mck-panel-cell">
                            <div class="mck-panel-inner mck-contacts-inner">
                                <ul id="mck-contact-list" class="people mck-contact-list mck-nav mck-nav-tabs mck-nav-stacked"></ul>
                            </div>
                            <div id="mck-contact-loading" class="mck-loading">
                                <img src="/static/images/ring.gif">
                            </div>
                            <div id="mck-no-contact-text" class="mck-no-data-text mck-text-muted n-vis">No conversations yet!</div>
                    ...
                    <div id="mck-tab-header" class="mck-box-top n-vis">
                        <div id="mck-tab-individual" class="mck-tab-individual mck-row">
                            <div class="blk-lg-8 mck-box-title">
                                ...
                                <div id="mck-individual-tab-title" class="mck-individual-tab-title">
                                    <div class="mck-tab-title mck-truncate name"></div>
                                    <div class="mck-tab-status mck-truncate n-vis"></div>
                                    <div class="mck-typing-box mck-truncate n-vis">
                                        <span class="name-text">typing...</span>
                            ...
                            <div v-if="privileges.chat.video_chat" id="mck-btn-video-call" class="mck-videocall-btn  blk-lg-2 n-vis" />
                            <div class="blk-lg-2 move-right">
                                <div id="mck-tab-menu" class="mck-menu-item mck-text-right">
                                    <div class="mck-dropdown-toggle" data-toggle="mckdropdown" aria-expanded="true">
                                        <img src="/static/images/icon-menu.png" class="mck-menu-icon" alt="Tab Menu">
                                    </div>
                                    <ul id="mck-tab-menu-list" class="mck-dropdown-menu mck-tab-menu-box menu-right" role="menu">
                                        <li class="mck-tab-message-option vis">
                                            <a href="#" id="mck-delete-button" class="mck-delete-button menu-item vis" title="Clear Messages"> Clear Messages </a>
                                        </li>
                                        <li id="li-mck-block-user" class="vis">
                                            <a href="#" id="mck-block-button" class="menu-item" title="Block User">Block User
                                            </a>
                                        </li>
                                        <li id="li-mck-group-info" class="mck-group-menu-options n-vis">
                                            <a href="#" id="mck-group-info-btn" class="menu-item mck-group-info-btn" title="Group Info">
                                                Group Info </a>
                                        </li>
                                        <li id="li-mck-leave-group" class="mck-group-menu-options n-vis">
                                    ...
                                    <div class="mck-row">
                                        ...
                                        <div class="blk-lg-9">
                                            <div class="mck-row">
                                                ...
                                                <div class="blk-lg-4 move-right mck-product-rt-up mck-truncate">
                                            ...
                                            <div class="mck-row">
                                                ...
                                                <div class="blk-lg-4 move-right mck-product-rt-down mck-truncate">
                                                    <strong class="mck-product-key"></strong>:
                                                    <span class="mck-product-value"></span>
                                                </div>
                                            </div>
                                ...
                                <div id="mck-write-box" class="blk-lg-12 mck-write-box">
                                    <form id="mck-msg-form" class="vertical mck-msg-form">
                                        ...
                                        <div id="mck-btn-attach" class="mck-btn-attach">
                                            <div class="mck-dropdown-toggle" data-toggle="mckdropdown" aria-expanded="true">
                                                <a href="#" type="" id="mck-btn-attach" class="write-link attach mck-btn-text-panel" aria-expanded="true" title="Attach File"> </a>
                                            </div>
                                            <ul id="mck-upload-menu-list" class="mck-dropup-menu mck-upload-menu-list" role="menu">
                                                <li>
                                                    <a id="mck-file-up" href="#" class="mck-file-upload menu-item" title="File &amp; Photos">
                                                        ...
                                                        <img src="/static/images/mck-icon-photo.png" class="menu-icon" alt="File &amp; Photos">
                                                        <span>Files &amp; Photos</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a id="mck-btn-loc" href="#" class="menu-item" title="Location"> <img src="/static/images/mck-icon-marker.png" class="menu-icon" alt="Location">
                                                        <span>Location</span>
                                                    </a>
                                                </li>
                                        ...
                                        <a href="#" id="mck-file-up2" type="" class="write-link attach n-vis mck-file-upload mck-btn-text-panel" title="Attach File"> </a>
                                        <a href="#" id="mck-mike-btn" type="" class="mck-mic-btn mck-mike-btn vis" title="Mike"></a>
                                        ...
                                        <a href="#" type="" id="mck-msg-sbmt" class="write-link send mck-btn-text-panel" title="Send Message"></a>
                                        <a href="#" type="" id="mck-btn-smiley" class="write-link smiley mck-btn-smiley mck-btn-text-panel" title="Smiley"></a>
                                    </form>
                                </div>
                                <div class="blk-lg-12">
            ...
            <div id="mck-group-create-tab" class="mck-group-create-tab mck-panel-sm mck-panel n-vis">
                <div class="panel-content">
                    <div class="mck-box-top">
                        ...
                        <div class="blk-lg-2">
                            <button type="button" id="mck-group-create-close" class="mck-box-close mck-close-panel move-right">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                    </div>
                                    ...
                                    <div id="mck-group-create-icon-box" class="mck-group-create-icon-box mck-group-icon-box mck-hover-on">
                                        ...
                                        <span class="mck-overlay-box">
                                            <div class="mck-overlay">
                                                ...
                                                <span class="mck-overlay-label">Add Group Icon</span>
                                            </div>
                                            <div id="mck-group-create-icon-loading" class="mck-loading n-vis">
                                                <img src="/static/images/mck-loading.gif" />
            ...
            <div id="mck-group-info-tab" class="mck-group-info-tab mck-panel-sm mck-panel n-vis">
                <div class="panel-content">
                        ...
                        <div class="mck-group-icon-sec">
                            <div id="mck-group-info-icon-box" class="mck-group-icon-box mck-group-info-icon-box mck-hover-on">
                                ...
                                <span class="mck-overlay-box n-vis">
                                    <div class="mck-overlay">
                                        <span class="mck-camera-icon"></span>
                                        <span class="mck-overlay-label">Change Group Icon</span>
                                    </div>
                            ...
                            <div class="mck-text-center">
                                <a id="mck-btn-group-icon-save" href="#" role="link" class="mck-btn-group-icon-save n-vis" title="Click to save">
                                    <img src="/static/images/mck-icon-save.png" alt="Save">
                                </a>
                            </div>
                        </div>
                        <div id="mck-group-name-sec" class="mck-group-name-sec">
                            <div id="mck-group-name-box" class="mck-row mck-group-name-box">
                                ...
                                <div class="blk-lg-3 mck-group-name-edit-icon">
                                    <a id="mck-group-name-edit" href="#" role="link" class="mck-group-name-edit vis" title="Edit"> <img src="/static/images/mck-icon-write.png" alt="Edit"></a>
                                    <a id="mck-group-name-save" href="#" role="link" class="mck-group-name-save n-vis" title="Click to save"> <img src="/static/images/mck-icon-save.png" alt="Save"></a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="mck-group-md-sec">
                                ...
                                <div id="mck-group-add-member-box" class="mck-row mck-group-admin-options mck-group-add-member-box n-vis">
                                    <a id="mck-group-add-member" class="mck-group-add-member" href="#">
                                        <div class="blk-lg-3">
                                            <img src="/static/images/mck-icon-add-member.png" alt="Add Member">
                                        </div>
                    ...
                    <div id="mck-group-info-ft" class="mck-group-info-ft">
                        <button type="button" id="mck-btn-group-exit" class="mck-btn mck-btn-blue mck-btn-group-exit" title="Exit Group">Exit Group
                        </button>
                    </div>
                </div>
            </div>
        ...
        <div id="mck-contact-search-box" class="mck-box mck-contact-search-box mck-sm-modal-box fade" aria-hidden="false">
                    ...
                    <div class="mck-box-body">
                        <div class="mck-form-group">
                            <div id="mck-contact-search-input-box" class="mck-input-group blk-lg-12">
                                ...
                                <span class="mck-search-icon">
                                    <a href="#" role="link" class="mck-contact-search-link">
                                        <span class="mck-icon-search"></span>
                                    </a>
                                </span>
                            </div>
                            <div id="mck-group-search-input-box" class="mck-input-group blk-lg-12 n-vis">
                                ...
                                <span class="mck-search-icon">
                                    <a href="#" role="link" class="mck-group-search-link">
                                        <span class="mck-icon-search"></span>
                                    </a>
                                </span>
                            </div>
                        ...
                        <div class="mck-tab-cell">
                            <div class="mck-message-inner">
                                <ul id="mck-contact-search-list" class="mck-contact-list mck-contact-search-list mck-nav mck-nav-tabs mck-nav-stacked"></ul>
        ...
        <div id="mck-goup-search-box" class="mck-box mck-group-search-box mck-sm-modal-box fade" aria-hidden="false">
            <div class="mck-box-dialog mck-box-sm">
                <div class="mck-box-content">
                    <div class="mck-box-top mck-row">
                        <div class="blk-lg-3">
                    ...
                    <div class="mck-box-body">
                        <div class="mck-form-group">
                            <div class="mck-input-group blk-lg-12">
                                ...
                                <span class="mck-search-icon">
                                    <a href="#" role="link" class="mck-group-member-search-link">
                                        <span class="mck-icon-search"></span>
                                    </a>
                                </span>
                            </div>
                        ...
                        <div class="mck-tab-cell">
                            <div class="mck-message-inner">
                                <ul id="mck-group-member-search-list" class=" mck-contact-list mck-group-search-list mck-nav mck-nav-tabs mck-nav-stacked"></ul>
                                <div id="mck-no-gsm-text" class="mck-no-data-text mck-text-muted n-vis">No Users!</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="mck-vid-scr-controls">
                        <div class="footer-controls pull-right">
                            ...
                            <button id="mck-vid-disconnect" class="btn-controls">
                                <svg class="A1NRff mck-disconnect-icon" xmlns="http://www.w3.org/2000/svg" focusable="false" width="24px" height="24px" viewBox="0 0 24 24">
...
//   require('//static/js/applozic.fullview.js')
  export default {
    data () {
      return {
        show: false
